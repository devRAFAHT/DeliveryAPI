...
public class RestaurantCreateDTO implements Serializable {
    @Serial
    ...
    public RestaurantCreateDTO(Long id, String taxIdentificationNumber, String companyName, String description, Instant createdAt, String phoneNumber, String imgProfileUrl, String imgBackgroundUrl, BigDecimal averagePrice, Integer estimatedDeliveryTime, Boolean isOpen, BigDecimal fixedDeliveryFee, AddressDTO address) {
        this.id = id;
    ...
    public RestaurantCreateDTO(Restaurant restaurantEntity) {
    ...
    public RestaurantCreateDTO(Restaurant restaurantEntity, Set<Menu> menus, Set<RestaurantCategory> categories, List<OperatingHours> operatingHours) {
