...
-- Dishes
INSERT INTO tb_dish (id, name, description, img_url, original_price, current_price, discount_in_percentage, preparation_time, food_restriction, sale_status, size, unit_measurement, dish_category_id, menu_id) VALUES (1, 'Macarrão Carbonara', 'Uma deliciosa massa carbonara com bacon e queijo parmesão.', 'https://example.com/macarrao_carbonara.jpg', 25.90, 25.90, 0.00, 1800000000000, 0, 0, NULL, 0, 5, 1);
INSERT INTO tb_dish (id, name, description, img_url, original_price, current_price, discount_in_percentage, preparation_time, food_restriction, sale_status, size, unit_measurement, dish_category_id, menu_id) VALUES (2, 'Frango Parmesão', 'Frango empanado com molho de tomate e queijo parmesão.', 'https://example.com/frango_parmesao.jpg', 29.90, 29.90, 0.00, 1800000000000, 0, 1, NULL, 0, 5, 1);
INSERT INTO tb_dish (id, name, description, img_url, original_price, current_price, discount_in_percentage, preparation_time, food_restriction, sale_status, size, unit_measurement, dish_category_id, menu_id) VALUES (3, 'Salmão Grelhado', 'Salmão grelhado com ervas finas.', 'https://example.com/salmao_grelhado.jpg', 35.90, 35.90, 0.00, 1800000000000, 0, 0, 200, 2, 5, 1);
INSERT INTO tb_dish (id, name, description, img_url, original_price, current_price, discount_in_percentage, preparation_time, food_restriction, sale_status, size, unit_measurement, dish_category_id, menu_id) VALUES (4, 'Risoto de Cogumelos', 'Risoto cremoso com mix de cogumelos frescos.', 'https://example.com/risoto_cogumelos.jpg', 28.50, 28.50, 0.00, 1800000000000, 0, 1, 150, 2, 5, 1);
INSERT INTO tb_dish (id, name, description, img_url, original_price, current_price, discount_in_percentage, preparation_time, food_restriction, sale_status, size, unit_measurement, dish_category_id, menu_id) VALUES (5, 'Bife à Cavalo', 'Bife grelhado com ovo frito.', 'https://example.com/bife_cavalo.jpg', 31.90, 31.90, 0.00, 1800000000000, 0, 1, 250, 2, 5, 1);
INSERT INTO tb_dish (id, name, description, img_url, original_price, current_price, discount_in_percentage, preparation_time, food_restriction, sale_status, size, unit_measurement, dish_category_id, menu_id) VALUES (6, 'Tacos Mexicanos', 'Tacos recheados com carne, queijo e molho especial.', 'https://example.com/tacos_mexicanos.jpg', 22.50, 22.50, 0.00, 1800000000000, 0, 0, 100, 2, 5, 1);
INSERT INTO tb_dish (id, name, description, img_url, original_price, current_price, discount_in_percentage, preparation_time, food_restriction, sale_status, size, unit_measurement, dish_category_id, menu_id) VALUES (7, 'Pizza Margherita', 'Pizza com molho de tomate, queijo mozzarella e manjericão.', 'https://example.com/pizza_margherita.jpg', 26.90, 26.90, 0.00, 1800000000000, 0, 1, 300, 2, 5, 1);
INSERT INTO tb_dish (id, name, description, img_url, original_price, current_price, discount_in_percentage, preparation_time, food_restriction, sale_status, size, unit_measurement, dish_category_id, menu_id) VALUES (8, 'Lasagna à Bolonhesa', 'Lasagna com molho à bolonhesa e queijo.', 'https://example.com/lasagna_bolonhesa.jpg', 32.90, 32.90, 0.00, 1800000000000, 0, 0, 400, 2, 5, 1);
INSERT INTO tb_dish (id, name, description, img_url, original_price, current_price, discount_in_percentage, preparation_time, food_restriction, sale_status, size, unit_measurement, dish_category_id, menu_id) VALUES (9, 'Sopa de Abóbora', 'Sopa cremosa de abóbora com especiarias.', 'https://example.com/sopa_abobora.jpg', 19.90, 19.90, 0.00, 1200000000000, 0, 0, 200, 2, 5, 1);
INSERT INTO tb_dish (id, name, description, img_url, original_price, current_price, discount_in_percentage, preparation_time, food_restriction, sale_status, size, unit_measurement, dish_category_id, menu_id) VALUES (10, 'Canelone de Ricota', 'Canelone recheado com ricota e espinafre.', 'https://example.com/canelone_ricota.jpg', 27.90, 27.90, 0.00, 1800000000000, 0, 0, 150, 2, 5, 1);

-- DISH VARIATIONS
INSERT INTO TB_DISH_VARIATION (ADDITIONAL_PRICE, PORTION_SIZE, DISH_ID, ID, SKU) VALUES (5.00, 1, 1, 1, 'VAR-CARBONARA-01');
INSERT INTO TB_DISH_VARIATION (ADDITIONAL_PRICE, PORTION_SIZE, DISH_ID, ID, SKU) VALUES (3.50, 2, 2, 2, 'VAR-FRANGO-01');
INSERT INTO TB_DISH_VARIATION (ADDITIONAL_PRICE, PORTION_SIZE, DISH_ID, ID, SKU) VALUES (7.00, 1, 3, 3, 'VAR-SALMAO-01');
INSERT INTO TB_DISH_VARIATION (ADDITIONAL_PRICE, PORTION_SIZE, DISH_ID, ID, SKU) VALUES (4.00, 1, 4, 4, 'VAR-RISOTO-01');
INSERT INTO TB_DISH_VARIATION (ADDITIONAL_PRICE, PORTION_SIZE, DISH_ID, ID, SKU) VALUES (6.00, 2, 5, 5, 'VAR-BIFE-01');
INSERT INTO TB_DISH_VARIATION (ADDITIONAL_PRICE, PORTION_SIZE, DISH_ID, ID, SKU) VALUES (2.50, 1, 6, 6, 'VAR-TACOS-01');
INSERT INTO TB_DISH_VARIATION (ADDITIONAL_PRICE, PORTION_SIZE, DISH_ID, ID, SKU) VALUES (5.50, 1, 7, 7, 'VAR-PIZZA-01');
INSERT INTO TB_DISH_VARIATION (ADDITIONAL_PRICE, PORTION_SIZE, DISH_ID, ID, SKU) VALUES (4.50, 2, 8, 8, 'VAR-LASAGNA-01');
INSERT INTO TB_DISH_VARIATION (ADDITIONAL_PRICE, PORTION_SIZE, DISH_ID, ID, SKU) VALUES (3.00, 1, 9, 9, 'VAR-SOPA-01');
INSERT INTO TB_DISH_VARIATION (ADDITIONAL_PRICE, PORTION_SIZE, DISH_ID, ID, SKU) VALUES (4.75, 2, 10, 10, 'VAR-CANELONE-01');
